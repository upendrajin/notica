...
function ROISection() {
  ...
  return (
    <section
      ref={sectionRef}
      className={`relative w-full py-24 overflow-hidden transition-all duration-700 ${
        visible ? "roi-visible" : "opacity-0 translate-y-16"
      }`}
      style={{ backgroundColor: "var(--bg-m)" }}
    >
      <div className="web-wave"></div>
        ...
        <div className="flex flex-wrap items-stretch">
          ...
          <div
            className={`w-full lg:w-1/2 transition-all duration-700 ${
              visible ? "roi-left-show" : "opacity-0 -translate-x-16"
            }`}
          >
            <div className="ROI-image">
              <img
          ...
          {/* RIGHT CONTENT */}
          <div
            className={`w-full lg:w-1/2 mt-12 lg:mt-0 lg:pl-16 flex flex-col justify-center transition-all duration-700 ${
              visible ? "roi-right-show" : "opacity-0 translate-x-16"
            }`}
          >
            <div className="text-start section-header-2">
              <h2 className="text-4xl font-bold mb-2">
            ...
            <div
              className="text-6xl fw-normal font-black text-green-700 mb-2"
            ...
            <p
              className="leading-7 max-w-md mb-7"
              style={{
                color: "var(--color-w-2)",
                fontWeight: "500",
              }}
            >
              Our business model is designed for fast and predictable ROI with
              low operating costs, minimal staffing, high repeat customers, and
              affordable pricing that ensures steady footfall.
            </p>

            <p className="font-medium mb-2" style={{ color: "var(--color-w-1)" }}>
              Expected monthly profit ranges from{" "}
              <span className="font-bold">₹30,000 to ₹3,00,000+</span>
            </p>

            <p className="font-medium" style={{ color: "var(--color-w-1)" }}>
              Smart investment.{" "}
              <span className="font-bold">Reliable returns.</span>
            </p>
          </div>
